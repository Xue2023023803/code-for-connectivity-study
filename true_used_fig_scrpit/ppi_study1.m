...
%
% 字体修改（2025-xx-xx）：
%   - ROI标签：Times New Roman 粗体，14号，水平放置
%   - 标题：Times New Roman 粗体，18号
%   - 图例：Times New Roman 正常粗细，12号
%   - 标签半径增大至1.42，坐标轴范围扩大至[-1.6,1.6]避免重叠
...
for ti = 1:numel(tags)
    ...
    % 标题上移 + 字体设置
    t = title(ax, sprintf('Group PPI | %s | %s', tag, vis_mode), ...
        'Interpreter','none', ...
